...
#Each Row in the data frame must have equal length ie) It should have equal no of column values
my_dataframe <- data.frame(a =c(1,2,3,4,5), b=c(1,2,3,4))
...
my.school.students <- data.frame(name=c("Krishna","Akshay","Nancy","Preethi"),
                                 Gender= factor("male","male","female","female"),
...
print(my.school.students)
#Lets add another column using cbin
...
new_student = c("Akshay","male",21,"Drawing",3)
